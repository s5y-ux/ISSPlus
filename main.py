...
pandas: Used to parse data for use in plotly (Could have used standard dictionaries but, better pratices yk?)
Documentation:
...
wikipedia: Used for proccessing data accoriding to the astronauts currently in space.
Documentation:
...
#Used as a simple way to access colors in string concatination "bcolors.attribute"
class bcolors:
    HEADER = '\033[95m'
    OKBLUE = '\033[94m'
    OKCYAN = '\033[96m'
...
class ISSPlus:
    ...
    #Way to access credits. Licence, Github, Docs, and return
    def credits(self):

        #Opens the credits so I dont flood the program with ASCII
        ...
        #Option for "Licence" (Assuming you diden't change the options variable 🤭)
        elif(Logic_Check(1)):
        ...
        #Option for "Documentation" (Assuming you diden't change the options variable 🤭)
        elif(Logic_Check(2)):
    ...
    def TrackISS(self):
        ...
        #Multi Demininsional list to store our latitude, longitude, and period on plotly
        Data = [[],[],[]]
        ...
        #Variable to store dataframe with the respective key value pairs referencing multi demensional array
        ...
        #Displays the plotly map via local webserver
        fig.show()
    ...
    def AstroGather(self):
        ...
        #Enumerates over the people in the resault
    ...
    def MainMenu(self):
        ...
        #Logic for option 0 "Track ISS" (Assuming you diden't change the options variable 🤭)
